...
const B = 'https://appin.site/nav/pxid-h5/public/';
const img = (p) => B + p;
...
const POSTS = [
  ...
  { a:'yan', pillar:'通勤实测', content:'颜值党通勤：星灰磨砂漆面回头率拉满。公司楼下被问了三次啥车，铝合金车架单手就能拎上楼，电梯里也不占地。通勤顺便还收获了好几个搭讪，值了。', imgs:['banner/banner-op2.jpg','plaza/plaza_p3.jpg'], tags:['颜值','通勤','改装'], car:'电助力自行车', likes:98, age:6, c:[['mo','颜值是第一生产力']] },
  { a:'bai', pillar:'通勤实测', content:'新手第一辆电助力，十分钟装好就骑走。手残党照说明书把车把脚踏座垫一装，前轮快拆，电池内置不怕淋，连工具都送了。不用去车行，通勤党友好度拉满。', imgs:['banner/banner-op3.jpg','plaza/plaza_p5.jpg'], tags:['新手','开箱','通勤'], car:'电助力自行车', likes:76, age:8, c:[['kai','新手友好yyds'],['jie','记得先充饱电再骑']] },
  { a:'zhang', pillar:'通勤实测', content:'冬天续航打几折？实测-5℃掉到7成。锂电通病，低温活性下降，我现在的对策：停地下车库、少急加速、回南天也别一直放户外。分享给怕冬天趴窝的兄弟。', imgs:['news/news-01-battery-passport.jpg','plaza/plaza_p2.jpg'], tags:['冬季','续航','保养'], car:'电助力自行车', likes:189, age:10, c:[['xu','保暖贴安排上'],['lee','北方用户泪目']] },
  ...
  { a:'kai', pillar:'通勤实测', content:'最后三公里地狱终结：滑板车5分钟到地铁。从家到地铁站走路15分钟，滑板车5分钟，到站轻轻一折拎进站，放脚边不占地方。以前觉得通勤是折磨，现在反而当成放空时间。', imgs:['banner/banner-scooter.jpg','plaza/plaza_p6.jpg'], tags:['电动滑板车','通勤','最后一公里'], car:'电动滑板车', likes:121, age:14, c:[['bai','最后一公里救星'],['xu','折叠党+1']] },

  // ===== 改装/颜值（用户）=====
  { a:'jie', pillar:'改装颜值', content:'给通勤车贴了隐形车衣，划痕拜拜。透明膜防刮，雨季泥点一擦就掉，漆面还是亮亮的。动手能力一般的也能自己贴，性价比极高。', imgs:['banner/banner-op1.jpg','plaza/plaza_p4.jpg'], tags:['改装','贴膜','颜值'], car:'电助力自行车', likes:88, age:4, c:[['yan','车衣真香'],['mo','细节控']] },
  { a:'yan', pillar:'改装颜值', content:'换了对宽胎，过减速带像踩软垫。原厂窄胎颠得龇牙咧嘴，换26寸宽胎抓地稳，过坑洼几乎无震感，比充气胎还省心。城市路况友好度直接上一档。', imgs:['plaza/plaza_p1.jpg','banner/banner-op2.jpg'], tags:['改装','轮胎','舒适'], car:'电助力自行车', likes:103, age:7, c:[['kai','宽胎党报到'],['lee','舒适第一']] },
  ...
  { a:'jie', pillar:'改装颜值', content:'自己调了助力曲线，运动模式爬坡不费力。APP里把助力档调高，分享下参数：平路3档、坡道直接拉5档，电机响应积极但不窜。动手能力强的可以试试。', imgs:['news/news-04-250w-motor.jpg','plaza/plaza_p7.jpg'], tags:['改装','三电','助力'], car:'电助力自行车', likes:67, age:11, c:[['lee','参数收了'],['xu','APP还能调？']] },
  { a:'lee', pillar:'改装颜值', content:'车把缠了皮质把套，手感直接上一档。长途不磨手，出汗也不滑，复古棕配星灰车身意外地搭。几十块的小改装，舒服度提升巨大。', imgs:['banner/banner-shot1.jpg','plaza/plaza_p8.jpg'], tags:['改装','舒适','骑行'], car:'电助力自行车', likes:54, age:13, c:[['yan','复古风爱了']] },
  { a:'kai', pillar:'改装颜值', content:'滑板车加了前灯+尾灯，夜骑敢出门了。之前怕黑只敢白天，现在亮度够照亮前面路，尾灯让后车一眼看见。夜间通勤安全感拉满。', imgs:['banner/banner-scooter.jpg','plaza/plaza_p6.jpg'], tags:['改装','夜骑','安全'], car:'电动滑板车', likes:79, age:16, c:[['bai','夜骑必备'],['mo','安全第一']] },
  { a:'yan', pillar:'改装颜值', content:'DIY了一个木纹车筐，买菜兜风两不误。复古风，同事都说好看，前面塞个咖啡+便当刚刚好。动手能力一般也能搞定，性价比拉满。', imgs:['banner/banner-op3.jpg','plaza/plaza_p3.jpg'], tags:['改装','颜值','生活'], car:'电助力自行车', likes:91, age:18, c:[['zhang','买菜神器'],['kai','颜值即正义']] },
  ...
  { a:'zhang', pillar:'骑行生活', content:'带娃逛公园，后座儿童椅真香。周末亲子，娃坐后面超开心，绿道平缓不怕摔。以前开车找车位半小时，现在直接骑到湖边。', imgs:['banner/banner-op2.jpg','plaza/plaza_p5.jpg'], tags:['亲子','生活','通勤'], car:'电助力自行车', likes:112, age:11, c:[['bai','带娃神器'],['yan','亲子风']] },
  ...
  { a:'yan', pillar:'骑行生活', content:'把车停咖啡馆门口，店员没多问。黑色极简风百搭不挑人，折叠立起来刚好塞进门边。城市漫步+一杯咖啡，周末松弛感拉满。', imgs:['banner/banner-op1.jpg','plaza/plaza_p4.jpg'], tags:['颜值','生活','城市'], car:'电助力自行车', likes:73, age:20, c:[['zhang','松弛感']] },
  { a:'bai', pillar:'骑行生活', content:'第一次夜骑公园，灯光亮到有点飘。新手夜骑体验，前灯铺路够宽，绿道没人刚好练手。提醒新手：慢点、戴头盔、走非机动车道。', imgs:['plaza/plaza_p8.jpg','banner/banner-shot2.jpg'], tags:['夜骑','新手','生活'], car:'电助力自行车', likes:49, age:22, c:[['kai','夜骑注意安全'],['mo','头盔必戴']] },
  ...
  // ===== 补充用户帖（拉满丰满度）=====
  { a:'zhang', pillar:'通勤实测', content:'通勤两个月，电费账单吓我一跳：9块。算笔账，以前开车一个月油费+停车小五百，现在电助力充电9块搞定，省下的钱够吃好几顿火锅了。', imgs:['banner/banner-op1.jpg','plaza/plaza_p2.jpg'], tags:['通勤','省钱','电助力自行车'], car:'电助力自行车', likes:134, age:4, c:[['yan','省出火锅'],['bai','算账党']] },
  { a:'xu', pillar:'骑行生活', content:'滑板车折叠后塞进办公桌底，同事都问链接。黑色极简风不挑场合，立起来刚好不挡路。办公室角落多了一台「通勤神器」，大家都种草了。', imgs:['banner/banner-scooter.jpg','plaza/plaza_p6.jpg'], tags:['电动滑板车','便携','通勤'], car:'电动滑板车', likes:95, age:10, c:[['kai','便携党'],['zhang','种草了']] },
  { a:'jie', pillar:'改装颜值', content:'给电助力加了挡泥板，雨天不再甩泥。前后挡泥一装，下雨天裤脚干干净净，通勤幸福感直线上升。小改装大不同，建议南方梅雨季必装。', imgs:['banner/banner-op3.jpg','plaza/plaza_p7.jpg'], tags:['改装','雨天','配件'], car:'电助力自行车', likes:71, age:16, c:[['yan','雨季必备'],['lee','细节控']] },
  { a:'lee', pillar:'骑行生活', content:'绿道夜骑装备清单（附灯+反光）。前灯铺路、尾灯警示、车轮反光条、反光背心，全套下来夜骑也安心。新手别裸骑，安全装备一步到位。', imgs:['banner/banner-shot1.jpg','plaza/plaza_p8.jpg'], tags:['夜骑','安全','装备'], car:'电助力自行车', likes:88, age:19, c:[['kai','夜骑安全'],['mo','背心必穿']] },
  { a:'yan', pillar:'改装颜值', content:'把通勤车做成复古咖啡车风，路人回头。米黄车架+木纹车筐+棕色把套，骑在路上像移动咖啡馆。颜值即正义，通勤也能很chill。', imgs:['banner/banner-op2.jpg','plaza/plaza_p3.jpg'], tags:['颜值','改装','生活'], car:'电助力自行车', likes:102, age:23, c:[['zhang','复古风绝'],['kai','chill']] },
  ...
  { a:'bai', pillar:'新手攻略', content:'新手最常问：电助力需要驾照吗？多数城市按非机动车管理、无需驾照，但要看当地对时速/重量的红线；电摩普遍要证。买前查本地规定最稳，别被商家一句"不用证"带偏。', imgs:['banner/banner-op1.jpg','plaza/plaza_p5.jpg'], tags:['新手','政策','答疑'], car:'电助力自行车', likes:64, age:30, c:[['official','政策贴参考'],['kai','答疑党']] },
