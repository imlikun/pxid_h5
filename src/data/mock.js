...
export const feedbackFaqs = [
  // 热门问题：综合高频（默认 tab）
  { id: 1, category: '热门问题', q: '如何查询附近门店？' },
  { id: 2, category: '热门问题', q: '车辆保修期多久？' },
  { id: 3, category: '热门问题', q: '电池续航里程怎么算？' },
  { id: 4, category: '热门问题', q: 'APP 连不上车怎么办？' },
  { id: 5, category: '热门问题', q: '如何申请道路救援？' },
  { id: 6, category: '热门问题', q: '发票怎么开？' },
  // 售后查询：质保、维修、退换、配件、工单
  { id: 11, category: '售后查询', q: '保修政策说明' },
  { id: 12, category: '售后查询', q: '保修期外如何收费？' },
  { id: 13, category: '售后查询', q: '维修工单进度查询' },
  { id: 14, category: '售后查询', q: '配件真伪验证' },
  { id: 15, category: '售后查询', q: '退换货流程与时效' },
  { id: 16, category: '售后查询', q: '事故车理赔对接' },
  // 使用指导：充电、保养、APP、车辆设置、安全
  { id: 21, category: '使用指导', q: '首次充电注意事项' },
  { id: 22, category: '使用指导', q: '电池保养建议' },
  { id: 23, category: '使用指导', q: '冬季续航下降正常吗？' },
  { id: 24, category: '使用指导', q: '仪表盘故障码解读' },
  { id: 25, category: '使用指导', q: '档位与动力模式切换' },
  { id: 26, category: '使用指导', q: '安全骑行须知' },
]
